...
public class PersonaControlador {
    ...
    public Persona editPersona(@PathVariable String id, @RequestParam("nombre") String nuevoNombre, @RequestParam("apellido") String nuevoApellido, @RequestParam("acerca") String nuevoAcerca, @RequestParam("img") String nuevoImg){
